       ...
       demo file shows several ways to process the input, for teaching purposes.
		...
		if (check) {
         ...
         (3) how to run NER on a whole file (without loading it into a String).
			...
			String fileContents = IOUtils.slurpFile("JD.txt");
			...
			//System.out.println(String.format("Java related technologies found in JD [%s]", technologiesFound));
			...
			System.out.println("Java related technologies found in JD " + dataSet);
